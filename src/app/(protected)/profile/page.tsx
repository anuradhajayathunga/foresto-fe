...
import { Camera, Mail, MapPin, Link as LinkIcon, User, Save, Loader2 } from 'lucide-react';
...
export default function ProfilePage() {
  ...
  const [data, setData] = useState({
    ...
    about: 'Passionate about building accessible and beautiful user experiences. Currently working on the next generation of SaaS tools.',
            ...
            <div className="h-32 bg-muted relative group">
                ...
                {isEditing && (
                    <label className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer text-white text-xs font-medium">
                        Change Cover
                        <input type="file" className="hidden" onChange={(e) => handleFileChange(e, 'coverPhoto')} accept="image/*" />
                    </label>
                )}
            </div>
            ...
            <CardContent className="pt-0 relative px-6 pb-6">
              ...
              <div className="relative -mt-12 mb-4 w-24 h-24 rounded-full border-4 border-background bg-background shadow-sm overflow-hidden group">
                ...
                {isEditing && (
                    <label className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
                        ...
                        <input type="file" className="hidden" onChange={(e) => handleFileChange(e, 'profilePhoto')} accept="image/*" />
                    </label>
                )}
              </div>
              ...
              <div className="mt-6 space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm text-muted-foreground">
                  ...
                  <a href={data.website} target="_blank" rel="noopener noreferrer" className="hover:text-primary hover:underline transition-colors">
                ...
                <CardContent>
                    <div className="flex items-center justify-between p-4 border rounded-lg bg-muted/20">
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">Your subscription renews on Nov 14, 2025.</p>
                        </div>
